<template>
     <div class="bg-white p-3 dark:bg-black dark:text-white rounded-lg flex flex-col items-center justify-between md:flex-row gap-3  ">
        <div class="flex flex-row gap-3" >
            <img class=" h-8 md:h-10 mx-auto rounded-full ring-2 ring-white dark:ring-gray-900 md:inline-block md:my-auto" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
            <div class="">
                <p class="md:hidden text-xs mb-2">abhijatain | May 12, 2024</p>
                <h5 class=" font-bold mb-2 ">
                    Best way to have GIF favicon but icon in all browsers?
                </h5>
                
                <p class="text-xs text-left md:hidden">235 Replies | 267K views</p>
                <p class="hidden text-xs mb-2 md:block">abhijatain | May 12, 2024</p>
            </div>
        </div>
    
        <div class="md:flex -space-x-1 overflow-hidden hidden">
        ...
        <div class="md:flex flex-row gap-3  hidden">
            <div class="p-1 border rounded-lg text-xs text-center">
